...
const Sidebar = () => {
  ...
  return (
    <div className="fixed flex flex-col top-0 left-0 w-50 xl:w-64 bg-gray-900 h-full shadow-lg">
      <div className="hidden xl:flex items-center pl-6 h-20 border-b border-gray-800">
        <img
        ...
        />
        <div className="ml-1">
          <p className="ml-1 mr-3 text-md font-medium tracking-wide truncate text-gray-100 font-sans">
            Samrendra
          </p>
        </div>
      </div>
      <div className="overflow-y-auto overflow-x-hidden flex-grow">
        <ul className="flex flex-col py-6 space-y-1">
          ...
          <li onClick={() => router.push("/newTask")}>
            <a
              href="#"
              className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-blue-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6"
            >
              <span className="inline-flex justify-center items-center ml-4">
                <svg
                  className="w-5 h-5"
